...
from .views import homePage, faq, referral, tos, dash
...
urlpatterns = [
    ...
    #PASSWORD RESET URLS
    path('reset_password/', auth_views.PasswordResetView.as_view(template_name='reset_password.html'), name='reset_view'),
